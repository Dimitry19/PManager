...
* The original package name 'cm.manager.package' is invalid and this project uses 'com.example.demo' instead.
...
* [Spring Integration](https://docs.spring.io/spring-boot/docs/2.3.0.RELEASE/reference/htmlsingle/#boot-features-integration)
