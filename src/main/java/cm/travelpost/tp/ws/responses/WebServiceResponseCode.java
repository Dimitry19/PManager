...
public class WebServiceResponseCode {
    ...
    public static final String MAIL_SPAM=".Verifier aussi parmi les spams";
    // OK LABEL
    public static final String MAIL_SENT_LABEL = "Le mail envoye correttement" +MAIL_SPAM;
    public static final String CANCELLED_USER_LABEL = "L'utilisateur a ete elimine correctement";
    public static final String RETRIVEVE_PASSWORD_LABEL = "Le mot de posse a ete envoye correctement..."+MAIL_SPAM;
