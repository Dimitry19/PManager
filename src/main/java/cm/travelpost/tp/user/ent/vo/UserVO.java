...
public class UserVO extends CommonVO {
    ...
    public static final String CONF_TOKEN = "cm.travelpost.tp.user.ent.vo.UserVO.findCToken";
    public static final String EMAIL = "cm.travelpost.tp.user.ent.vo.UserVO.findByEmail";
