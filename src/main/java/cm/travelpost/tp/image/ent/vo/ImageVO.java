...
public class ImageVO extends WSCommonResponseVO {
    ...
    public static final String IMG_BY_NAME = "cm.travelpost.tp.common.ent.vo.ImageVO.byName";
	...
	public byte[] getPicByte() {
		return ImageUtils.decompressImage(picByte);
	}

	public void setPicByte(byte[] picByte) {
		this.picByte = ImageUtils.compressImage(picByte);
	}
