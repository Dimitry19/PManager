...
public class Utility {
        ...
        if (millisec > 999) {
            ...
            if (seconds > 59) {
                ...
                if (minutes > 59) {
                    ...
                    minutes = minutes % 60;
                    ret = hours + ":" + normalizeMinSec(minutes) + ":" + normalizeMinSec(seconds) + "." + normalizeMillis(millis);
                } else
                    ret = "00:" + normalizeMinSec(minutes) + ":" + normalizeMinSec(seconds) + "." + normalizeMillis(millis);
    ...
    String normalizeWhitespaces(String s) {
        ...
        while ((currIndex = s.indexOf(searchString, currIndex + 1)) >= 0) {
            res.append(s, prevIndex, currIndex + 1);
