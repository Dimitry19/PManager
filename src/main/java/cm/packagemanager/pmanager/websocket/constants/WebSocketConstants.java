...
public class WebSocketConstants {
    ...
    public static final String SUSCRIBE_QUEUE_ITEM_SEND = "/user/notification/item";
    public static final String SUSCRIBE_QUEUE_COMMENT_SEND = "/user/notification/comment";
    public static final String SUSCRIBE_QUEUE_ANNOUNCE_SEND = "/user/notification/announce";
    public static final String SUSCRIBE_QUEUE_USER_SEND = "/user/notification/user";
