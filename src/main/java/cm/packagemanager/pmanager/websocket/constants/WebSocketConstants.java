...
public class WebSocketConstants {
    ...
    public static final String SEND ="/notification/item";
    public static final String COMMENT_SEND ="/notification/comment";
    public static final String ANNOUNCE_SEND ="/notification/announce";
