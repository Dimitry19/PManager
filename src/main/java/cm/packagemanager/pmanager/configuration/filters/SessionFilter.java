...
import static cm.packagemanager.pmanager.configuration.filters.CommonFilter.getRolesAuthoritiesUser;
...
//        }
    ...
    public List<SimpleGrantedAuthority> getRolesFromToken(String token) {
        ...
        Boolean isAdmin = claims.get(claimsAdminKey, Boolean.class);
        Boolean isUser = claims.get(claimsUserKey, Boolean.class);
