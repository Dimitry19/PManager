...
public class UserEntityController extends CommonControler {

	protected final Log logger = LogFactory.getLog(UserEntityController.class);
	...
	@RequestMapping(value = "/delete/{id}", method = RequestMethod.GET, headers =WSConstants.HEADER_ACCEPT)
