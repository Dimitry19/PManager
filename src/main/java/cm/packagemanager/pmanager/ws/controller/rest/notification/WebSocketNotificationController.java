...
import static cm.packagemanager.pmanager.constant.WSConstants.SUBSCRIPTIONS_SOCKET_WS;
...
public class WebSocketNotificationController extends CommonController {
    ...
    @ResponseBody
    public List<String> topics(@RequestParam @Valid String topic) throws Exception {
