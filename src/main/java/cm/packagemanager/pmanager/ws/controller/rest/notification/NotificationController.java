...
public class NotificationController extends CommonController {
    ...
    public ResponseEntity<NotificationVO> read(HttpServletResponse response, HttpServletRequest request, @RequestParam @Valid Long id) throws Exception {
        ...
        try {
            ...
            if (id != null) {
                ...
                if (notification == null) return new ResponseEntity<>((NotificationVO) null, HttpStatus.NOT_FOUND);
            }
